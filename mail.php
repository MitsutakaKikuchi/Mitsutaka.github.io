...
$BccMail = "kiku.mitsu.yoshi.taka@gmail.com";
			...
			<div class="header-pad">
				...
				<container class="news-container">
					<div id="news" class="box-shadow">
						<container id="keiko">
							...
							<div id="formWrap">
								...
								<?php if ($empty_flag == 1) { ?>
									<div>
										<h4 align="left">入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4>
										<?php echo $errm; ?><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()">
									</div>
								<?php } else { ?>
									<h3 align="center">確認画面</h3>
					...
					<div id="submenu">
						<ul>
							<li class="box-shadow">
								<a class="subcontents sensu" href="about.html">直派分家若柳流とは</a>
							</li>
							<li class="box-shadow">
								<a class="subcontents keiko" href="info.html">お稽古場のご案内</a>
							</li>
							<!-- <li class="box-shadow"><a class="subcontents keiko" href="info.html">お稽古のご案内</a></li> -->
							<li class="box-shadow">
								<a class="subcontents senjukai" href="https://www.facebook.com/%E6%97%A5%E6%9C%AC%E8%88%9E%E8%B8%8A-%E7%9B%B4%E6%B4%BE%E5%88%86%E5%AE%B6%E8%8B%A5%E6%9F%B3%E6%B5%81-319206524870126">活動の様子</a>
							</li>
						</ul>
					</div>
				</container>
...
function copyright()
{
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="index.php" target="_blank">- 直派分家若柳流 -</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
